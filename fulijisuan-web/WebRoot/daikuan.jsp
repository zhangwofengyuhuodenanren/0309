...
<html>
  <head>
    ...
    <title>My JSP 'daikuan.jsp' starting page</title>
  ...
  <body style="background-color:#ffff66">
	...
	<p>
  	...
  	if(YEARS==null){
		...
		double FINALLY = M *  (((R / 12) * (Math.pow(1 + R / 12, Y * 12))) / (Math.pow((1 + R / 12), Y * 12) - 1));
		out.println("<div align='center'>年期："+Y);
		out.println("<div align='center'>贷款金额："+N);
		out.println("<div align='center'>利率："+R);	
		out.println("<div align='center'><strong>每月还款为："+FINALLY);
		}
