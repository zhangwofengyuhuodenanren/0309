...
<html>
  <head>
    ...
    <title>My JSP 'zongefuli.jsp' starting page</title>
  ...
  <body style="background-color:#ffff66">
	...
	<form name="form1" method="post" action="">
		<table width="400" border="2" align="center" cellpadding="0"
			...
			<tr>
				<th height="30" align="right" bgcolor="#00FFFF">复利次数：</th>
	...
	<p>
	  <%
  		...
  		String TIME= request.getParameter("cishu");
  		double M=0,R=0;
  		int Y=0,T=0;
  	if(MONEY==null){
		MONEY="0";
